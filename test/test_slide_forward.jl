...
@testset "slide_forward" begin
    ...
    n_layers = 1
    neuron_1 = Neuron(1, Array{Float32}([1.0, 1.0, 1.0]), 0, zeros(1), zeros(1), zeros(1, 1), zeros(1))
    neuron_2 = Neuron(2, Array{Float32}([0.0, 0.0, 0.0]), 1, zeros(1), zeros(1), zeros(1, 1), zeros(1))
    network =
